...
--O gerente quer uma lista apenas dos jogos que custam o mais de 200,00
SELECT * FROM jogo;
...
SELECT * FROM jogo
SELECT * FROM jogo WHERE ds_categoria = 'Ação'
SELECT * FROM jogo ORDER BY qtd_copias_vendidas DESC;




--Exiba todos os jogos de terror em ordem ordem alfabética inversa!
SELECT * FROM jogo
SELECT * FROM jogo WHERE ds_categoria = 'Terror'
SELECT * FROM jogo ORDER BY nm_jogo DESC;
